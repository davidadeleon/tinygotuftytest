...
type PIO_FIFO_JOIN int
const (
	PIO_FIFO_JOIN_NONE PIO_FIFO_JOIN = iota
	PIO_FIFO_JOIN_TX
	PIO_FIFO_JOIN_RX
)
 ...
 */
func (cfg *PIOStateMachineConfig) SetSidePins(pin Pin) {
 ...
 */
func (cfg *PIOStateMachineConfig) SetFIFOJoin(join PIO_FIFO_JOIN) {
...
*/
func (sm *PIOStateMachine) IsTXFIFOEmpty() bool {
